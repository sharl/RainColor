...
ツールチップにアメダスから取得した気温・湿度・気圧などを表示

![screen shot](Assets/image_w.png)
...
雨が降っていないのに検出される場合ツールチップに検出した色(例 146 146 143)が表示されるので、それを設定してください
